...
import GitHubSvg from "@/containers/svgs/GitHubSvg";
  ...
  return (
    <footer className="text-xs container flex flex-col items-center justify-between p-6 mx-auto space-y-4 sm:space-y-0 sm:flex-row">
        <Link href="/" rel="noreferrer noopener">
          <h1 className="text-emerald-50/80">{data.brandName}</h1>
        </Link>
        ...
        <div className="flex mx-2">
          <Link
            ...
            className="mx-2 text-emerald-50/70 transition-colors duration-300 hover:text-emerald-200"
            aria-label="Github"
          >
            {/* <svg
